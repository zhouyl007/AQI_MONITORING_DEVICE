...
#define LCD_SWAP_XY  0 // for testing
...
// Buffers / VScreens
//
#define NUM_BUFFERS  3 // Number of multiple buffers to be used /* 1 for testing */
...
#define GUI_NUM_LAYERS 1 /* 2 for testing */
...
*       Layer 1
*/
#define COLOR_MODE_1 _CM_RGB565 /* _CM_ARGB1555 for testing */
//
// Layer size
//
#define XSIZE_1 240
...
static void _LCD_InitController(int LayerIndex) {
  ...
  // Layer configuration
  //
  xSize = LCD_GetXSizeEx(LayerIndex); // for testing
  ySize = LCD_GetYSizeEx(LayerIndex); // for testing
