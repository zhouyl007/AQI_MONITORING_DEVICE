...
*	文件名称 : GUI_X_RTX.c
*	版    本 : V1.0
*	说    明 : 本文件来自KEIL官方，为支持V6开发板，修改地方有2
*              1. GUI_X_GetTime直接由os_time_get获取。
*              2. 任务SysTick_Task不需要单独创建，将其注释掉。
*              
*	修改记录 :
*		版本号    日期         作者            说明
*       V1.0    2016-01-10   Eric2013    1. RL-FlashFS版本V4.74
*
...
GUI_TIMER_TIME GUI_X_GetTime(void) { 
  return ((GUI_TIMER_TIME)os_time_get());
}
